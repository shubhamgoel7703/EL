...
router.post('/flowdata', function (req, res, next){
    ...
    return res.send("ok flowdata set");//send("flowdata set as ",req.body.flowdata);
});
...
router.post('/setpoint', function (req, res, next){
    ...
    console.log("in setpoint status");
     ...
     //flowData=req.body.setpoint;;

    console.log(req.body.setpoint);
    return null;//res.status(200);//send("setpoint set as ",req.body.setpoint);
});
